...
class W2l:
    def __init__(
        ...
        self.wav2lip_folder = os.path.sep.join(
        ...
        self.checkpoint_path = (
            self.wav2lip_folder + "/checkpoints/" + self.checkpoint + ".pth"
        )
    ...
    def face_detect(self, images):
        ...
        for rect, image in zip(predictions, images):
            if rect is None:
                print("Hum : " + str(n))
                cv2.imwrite(
                    self.wav2lip_folder + "/temp/faulty_frame.jpg", image
    ...
    def datagen(self, frames, mels):
        ...
        if self.box[0] == -1:
            ...
            if self.box[0] == -2:
                y1, y2, x1, x2 = self.face_detect([frames[0]])[0][1]
    ...
    def execute(self):
        ...
        for i, (img_batch, mel_batch, frames, coords) in enumerate(
            ...
            if i == 0:
                ...
                out = cv2.VideoWriter(
                    self.wav2lip_folder + "/temp/result.avi",
